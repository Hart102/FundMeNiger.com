  ...
  <section class="inner-page">
    <div class="container">
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to <?php echo BANKNAME ?>, <?php echo ADDRESS ?>.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to <?php echo BANKNAME ?>, accessible from <a href="http://www.<?php echo BANKNAME ?>.com" rel="external nofollow noopener" target="_blank">http://www.<?php echo BANKNAME ?>.com</a></p>
        </li>
        <li>
