                ...
                <nav class="navbar navbar-expand navbar-light my-navbar">
                    ...
                    <form class="d-none d-sm-inline-block form-inline navbar-search">
                        <div class="input-group">
                            ...
                            <div class="ml-4">
                                <button class="btn btn-outline-warning"><strong> Report an Issue </strong></button>
                            </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                                ...
                                <img id="Header" hidden class="img- rounded-circle">
                                <span id="HeaderTag" class="btn btn-circle text-white" style="font-size: 13px; background-color: <?php echo $_SESSION['Color'] ?>;"><?php echo strtoupper($_SESSION['ProfileText']) ?></span>
                            </a>
