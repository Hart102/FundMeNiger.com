                    ...
                    <div class="col-sm-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text mb-4 pl-2 pr-2"><?php echo BANKNAME ?></p>
                                                    ...
                                                    <div class="card dcard-back">
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-between">
                                                                <h5 class="text-light"><?php echo BANKNAME ?></h5>
...
<p class="description">This card issued by <?php echo BANKNAME ?> Bank pursuant to a license from Visa, United States Of America, Inc. Use of this card is subject to the agreement, as amended, This card is the property of the issuer and must be returned upon request and may be revoked without notice.</p>
